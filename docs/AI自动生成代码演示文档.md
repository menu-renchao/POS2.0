...
- 报告体系：Allure + 中文步骤
- 浏览器：Chrome
- 主要入口：`http://192.168.0.72:22080/kpos/front/myhome.html`
...
入口与前置条件：
1. 必须从 http://192.168.0.72:22080/kpos/front/myhome.html 进入。
...
```ts
await page.goto('/kpos/front/myhome.html#orderDishes');
```
