...
- Test plan file (optional): the test plan file to write, default under `specs/generated/`.
...
2. For each test case from the test plan file (1.1, 1.2, ...), one after another, not in parallel, call #playwright-test-generator subagent with prompt:
  ...
  <test-file><!-- Name of the file to save the test into, prefer tests/generated/*.spec.ts --></test-file>
...
<heal>Run tests under tests/generated and fix the failing ones one after another.</heal>
