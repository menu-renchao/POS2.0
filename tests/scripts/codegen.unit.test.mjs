...
test('应提供自定义 Codegen 与脚本测试入口', async () => {
  ...
  assert.equal(
    ...
    'node --test tests/scripts/codegen.unit.test.mjs tests/scripts/capture-case.unit.test.mjs tests/scripts/generate-jenkins-test-tree.unit.test.mjs tests/scripts/jenkinsfile-ui-scope.unit.test.mjs tests/scripts/check-ui-architecture.unit.test.mjs',
  );
